...
import { DashboardLayaoutComponent } from './presentation/layout/dashboardLayaout/dashboardLayaout.component';
...
export const routes: Routes = [
  {
    ...
    children: [
...

      {
        path: 'assistant',
        loadComponent: () =>
          import('./presentation/pages/assitentPage/assitentPage.component'),
        data: {
